...
public class ClienteConsumidor {
	public static void main(String[] args) {
		MarcoCliente2 mimarco1 = new MarcoCliente2();
		mimarco1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	}
}

class MarcoCliente2 extends JFrame implements Runnable {
	public MarcoCliente2() {
		setBounds(1000, 500, 500, 500);
		setLayout(null);
		setTitle("Cliente Consumidor");
	...
	private class SendText implements ActionListener {
		public void actionPerformed(ActionEvent arg0) {
			try {
				Socket elsocket = new Socket("192.168.0.2", 8889);
